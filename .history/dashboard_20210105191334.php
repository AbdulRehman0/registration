...
<table class="table">
  ...
  <tbody>
    ...
    <td><a href="./controllers/edit.php?id=<?php echo $row["id"]?>"><span>Edit<span></a><a href="./controllers/UserController.php?id=<?php echo $row["id"]?>&func=deleteUser"><span>Delete<span></a><?php echo "action"?></td>
    </tr>
    <?php endforeach;?>
