...
<table class="table">
  ...
  <tbody>
    ...
    <td><a href="./controllers/edit.php?id=<?php echo $row["id"]?>" class="float-left"><span>Edit<span></a><?php if($row["role_id"]!=1):?><a href="./controllers/UserController.php?id=<?php echo $row["id"]?>&func=deleteUser" class="center"><span>Delete<span></a></td>
    </tr>
    <?php endforeach;?>
